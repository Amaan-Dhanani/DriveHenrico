<script lang="ts">
	...
	import type { ToggleableWritable } from '../../internal';
...
>
	...
	<SpeedDial.Item
		slot="anchor"
		class="bg-primary-500 hover:bg-primary-400 group text-gray-300 [&>svg]:transition-all [&>svg]:ease-in-out"
	>
		<div
			class={cn(
				'group-hover:rotate-20 shrink-0 text-white',
